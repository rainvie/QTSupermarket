...
template <> constexpr inline auto Product::qt_create_metaobjectdata<qt_meta_tag_ZN7ProductE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onImportDataClicked",
        "onExportDataClicked",
        "onTakeProductClicked",
        "onBackToLoginTriggered",
        "onViewSalesStatisticsClicked",
        "onModifyReorderPointClicked",
        "onGenerateInventoryReport",
        "onShowInventoryChartsClicked",
        "onGenerateReportStatistics"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onPutProductClicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onSearchProductClicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onImportDataClicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onExportDataClicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onTakeProductClicked'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onBackToLoginTriggered'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewSalesStatisticsClicked'
        QtMocHelpers::SlotData<void()>(11, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onModifyReorderPointClicked'
        QtMocHelpers::SlotData<void()>(12, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onGenerateInventoryReport'
        QtMocHelpers::SlotData<void()>(13, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onShowInventoryChartsClicked'
        QtMocHelpers::SlotData<void()>(14, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onGenerateReportStatistics'
...
void Product::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onPutProductClicked(); break;
        case 4: _t->onSearchProductClicked(); break;
        case 5: _t->onImportDataClicked(); break;
        case 6: _t->onExportDataClicked(); break;
        case 7: _t->onTakeProductClicked(); break;
        case 8: _t->onBackToLoginTriggered(); break;
        case 9: _t->onViewSalesStatisticsClicked(); break;
        case 10: _t->onModifyReorderPointClicked(); break;
        case 11: _t->onGenerateInventoryReport(); break;
        case 12: _t->onShowInventoryChartsClicked(); break;
        case 13: _t->onGenerateReportStatistics(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Product::*)()>(_a, &Product::backToLogin, 0))
            return;
    }
}
