...
public:
    ...
    void setupUi(QDialog *RegisterDialog)
    {
        ...
        verticalLayoutWidget_2->setGeometry(QRect(10, 120, 320, 250));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(10, 380, 320, 50));
        ...
        line->setGeometry(QRect(10, 100, 281, 16));
        line->setFrameShape(QFrame::Shape::HLine);
        line->setFrameShadow(QFrame::Shadow::Sunken);
        line_2 = new QFrame(RegisterDialog);
        line_2->setObjectName("line_2");
        line_2->setGeometry(QRect(10, 365, 320, 16));
